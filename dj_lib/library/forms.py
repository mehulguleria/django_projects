...
class IssueBookForm(forms.Form):
    isbn2 = forms.ModelChoiceField(queryset=models.Book.objects.all().exclude(no_of_books=0), empty_label="Book Name [ISBN]", to_field_name="isbn", label="Book (Name and ISBN)")
